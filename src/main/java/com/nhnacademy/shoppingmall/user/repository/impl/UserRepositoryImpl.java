...
public class UserRepositoryImpl implements UserRepository {
    ...
    public Optional<User> findByUserIdAndUserPassword(String userId, String userPassword) {
        ...
        try (PreparedStatement psmt = connection.prepareStatement(sql)) {
            ...
            throw new RuntimeException("아이디 패스워드 조회 실패", e);
        }
    ...
    public Optional<User> findById(String userId) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            throw new RuntimeException("아이디 조회 실패", e);
        }
        return Optional.empty();
    }
    ...
    public int save(User user) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            if (e instanceof SQLIntegrityConstraintViolationException) {
                throw new RuntimeException(SQLIntegrityConstraintViolationException.class.getName() + ": 중복된 사용자 ID", e);
            }
            throw new RuntimeException("세이브에 실패 하였습니다.", e);
        }
    }
    ...
    public int deleteByUserId(String userId) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            throw new RuntimeException("삭제에 실패 하였습니다.", e);
        }
    }
    ...
    public int update(User user) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            throw new RuntimeException("회원 정보 업데이트 실패 - " + user.getUserId(), e);
        }
    }
    ...
    public int updateLatestLoginAtByUserId(String userId, LocalDateTime latestLoginAt) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            throw new RuntimeException("회원 정보 업데이트 실패 - " + userId, e);
        }
    }
    ...
    public int countByUserId(String userId) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            throw new RuntimeException("회원 수 조회 실패 - " + userId, e);
        }
    }
}
